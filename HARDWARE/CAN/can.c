...
void CAN_NodeID_Update(void)
{
	...
	if(gSensor.CanID.m_ID < 800){
		...
		UAVCAN_NODE_ID_SELF_ID = 9;	
	else if (gSensor.CanID.m_ID < 2000)
		UAVCAN_NODE_ID_SELF_ID = 10;
	else if (gSensor.CanID.m_ID < 3200)
		UAVCAN_NODE_ID_SELF_ID = 11;	
	else
		UAVCAN_NODE_ID_SELF_ID = 0;
}
...
{
	CAN_tx_buf[0] = gSensor.Sonar01.m_Distance & 0xFF;
	CAN_tx_buf[1] = (gSensor.Sonar01.m_Distance>>8) & 0xFF;

	CAN_tx_buf[2] = gSensor.Sonar02.m_Distance & 0xFF;
	CAN_tx_buf[3] = (gSensor.Sonar02.m_Distance>>8) & 0xFF;

	CAN_tx_buf[4] = gSensor.Sonar03.m_Distance & 0xFF;
	CAN_tx_buf[5] = (gSensor.Sonar03.m_Distance>>8) & 0xFF;

	CAN_tx_buf[6] = gSensor.Sonar04.m_Distance & 0xFF;
	CAN_tx_buf[7] = (gSensor.Sonar04.m_Distance>>8) & 0xFF;
	
	CAN_tx_buf[8] = gSensor.Sonar05.m_Distance & 0xFF;
	CAN_tx_buf[9] = (gSensor.Sonar05.m_Distance>>8) & 0xFF;
	
	CAN_tx_buf[10] = gSensor.Sonar06.m_Distance & 0xFF;
	CAN_tx_buf[11] = (gSensor.Sonar06.m_Distance>>8) & 0xFF;
	
	CAN_tx_buf[12] = gSensor.InfraredSensor.Infra01.m_Distance & 0xFF;
	CAN_tx_buf[13] = gSensor.InfraredSensor.Infra01.m_Distance >>8 & 0xFF;

	CAN_tx_buf[14] = gSensor.InfraredSensor.Infra02.m_Distance & 0xFF;
	CAN_tx_buf[15] = gSensor.InfraredSensor.Infra02.m_Distance >>8 & 0xFF;	
